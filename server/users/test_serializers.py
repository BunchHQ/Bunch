...
class UserSerializerTest(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.root_access_token, self.root_refresh_token = (
            self.__generate_token_pair(
    ...
    def test_generate_access_token_using_refresh_token(
        self,
    ):
