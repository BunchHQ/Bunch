...
class UserModelTest(TestCase):
    ...
    def test_creation(self):
        ...
        self.assertTrue(
            user.check_password("testpassword"),
            "Password is not correct",
        )
        self.assertEqual(
            str(user),
            user.username,
            "String representation of user is not username",
        )
    ...
    def test_all_attributes(self):
        ...
        self.assertTrue(
            hasattr(user, "id"),
            "User does not have id attribute",
        )
        self.assertTrue(
            hasattr(user, "email"),
            "User does not have email attribute",
        )
        self.assertTrue(
            hasattr(user, "avatar"),
            "User does not have avatar attribute",
        )
        self.assertTrue(
            hasattr(user, "status"),
            "User does not have status attribute",
        )
        self.assertTrue(
            hasattr(user, "bio"),
            "User does not have bio attribute",
        )
        self.assertTrue(
        ...
        self.assertTrue(
            hasattr(user, "color"),
            "User does not have color attribute",
        )
        self.assertTrue(
            hasattr(user, "pronoun"),
            "User does not have pronoun attribute",
        )
