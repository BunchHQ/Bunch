...
export function MessageList() {
    ...
    if (wsMessages.length > 0) {
      ...
      for (const wsMessage of wsMessages) {
        ...
        // Handle reaction events
          ...
          wsMessage.type === WSMessageTypeClient.REACTION_NEW ||
          wsMessage.type === WSMessageTypeClient.REACTION_DELETE
        ) {
  ...
  const ConnectionStatus = () => {
    if (!isConnected) {
      return (
        <div className="rounded-md bg-yellow-100 p-2 text-center text-sm text-yellow-800">
